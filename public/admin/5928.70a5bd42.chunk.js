(self.webpackChunkreportrack=self.webpackChunkreportrack||[]).push([[5928],{94445:N=>{function k(c,s,y,m){for(var j=-1,v=c==null?0:c.length;++j<v;){var A=c[j];s(m,A,y(A),c)}return m}N.exports=k},7233:(N,k,c)=>{var s=c(97449);function y(m,j,v,A){return s(m,function($,S,I){j(A,$,v($),I)}),A}N.exports=y},88532:(N,k,c)=>{var s=c(94445),y=c(7233),m=c(45353),j=c(82261);function v(A,$){return function(S,I){var J=j(S)?s:y,Q=$?$():{};return J(S,A,m(I,2),Q)}}N.exports=v},94710:(N,k,c)=>{var s=c(95292),y=c(88532),m=Object.prototype,j=m.hasOwnProperty,v=y(function(A,$,S){j.call(A,S)?A[S].push($):s(A,S,[$])});N.exports=v},35928:(N,k,c)=>{"use strict";c.d(k,{P:()=>Rs});var s=c(92132),y=c(21272),m=c(43242),j=c(44370),v=c(72182),A=c(57842),$=c(69564),S=c(50642),I=c(6479),J=c(53900),Q=c(32161),ue=c(80846),q=c(47098),he=c(96294),ge=c(80725),re=c(12050),we=c(57564),Ge=c(68065),Je=c(15926),Ae=c(44622),ee=c(83724),Oe=c(16136),Ee=c(88761),me=c(51187),M=c(2600),ae=c(412),se=c(77965),H=c(48940),K=c(54894),w=c(10631),Xe=c(95267),Ye=c(59080),Ce=c(94710),be=c(35223),L=c(79793),Ze=c(28556),ze=c(28816),Qe=c(99787),qe=c(7448),es=c(32372),ss=c(714),ts=c(39404);const[ns,os]=(0,Xe.q)("PermissionsDataManager"),Z=()=>os("usePermissionsDataManager"),Me=e=>Array.isArray(e)?e.reduce((t,o)=>(Array.isArray(o)?t.push(...Me(o)):t.push(o),t),[]):[],X=e=>(0,w.F)(e)?Me(Object.values(e).map(t=>(0,w.F)(t)?X(t):t)):[],ve=(e,t,o)=>e.find(n=>n.action===t&&n.subject===o),is=e=>{const t=Pe(e.plugins),o=Pe(e.settings),n=Te(e.collectionTypes),r=Te(e.singleTypes);return[...t,...o,...n,...r]},Pe=e=>Object.values(e).reduce((t,o)=>{const n=Object.values(o).reduce((r,a)=>{const d=Object.entries(a).reduce((i,[l,{conditions:p,properties:{enabled:u}}])=>(u&&i.push({action:l,subject:null,conditions:xe(p),properties:{}}),i),[]);return[...r,...d]},[]);return[...t,...n]},[]),Te=e=>Object.entries(e).reduce((o,n)=>{const[r,a]=n,d=Object.entries(a).reduce((i,l)=>{const[p,u]=l;if(!X(u).some(C=>C))return i;if(!u?.properties?.enabled){const C=Object.entries(u.properties).reduce((f,_)=>{const[h,x]=_;return f.properties[h]=De(x),f},{action:p,subject:r,conditions:xe(u.conditions),properties:{}});return[...i,C]}return u.properties.enabled&&i.push({action:p,subject:r,properties:{},conditions:xe(u.conditions)}),i},[]);return[...o,...d]},[]),De=(e,t="")=>Object.entries(e).reduce((o,n)=>{const[r,a]=n;return(0,w.F)(a)?[...o,...De(a,`${t}${r}.`)]:(a&&!(0,w.F)(a)&&o.push(`${t}${r}`),o)},[]),xe=e=>Object.entries(e).filter(([,t])=>t).map(([t])=>t),Se=(e,t=[])=>e.reduce((o,n)=>(o[n.id]=t.indexOf(n.id)!==-1,o),{}),$e=(e,t,o=[])=>e.reduce((n,{categoryId:r,childrenForm:a})=>{const d=a.reduce((i,l)=>(i[l.subCategoryId]=l.actions.reduce((p,u)=>{const g=ve(o,u.action,null);return p[u.action]={properties:{enabled:g!==void 0},conditions:Se(t,g?.conditions??[])},p},{}),i),{});return n[r]=d,n},{}),rs=(e,t,o)=>{const n=({children:r=[]},a,d="")=>r.reduce((i,l)=>{if(l.children)return{...i,[l.value]:n(l,a,`${d}${l.value}.`)};const p=a.indexOf(`${d}${l.value}`)!==-1;return i[l.value]=p,i},{});return e.reduce((r,a)=>{const d=t.properties.find(({value:i})=>i===a);if(d){const i=o?.properties[d.value]??[],l=n(d,i);r.properties[a]=l}return r},{properties:{}})},Le=({subjects:e,actions:t=[]},o,n=[])=>t.reduce((r,a)=>{const d=a.subjects.reduce((l,p)=>{const u=e.find(({uid:g})=>g===p)||null;return u&&(l[p]=u),l},{});if(se(d))return r;const i=Object.keys(d).reduce((l,p)=>{const{actionId:u,applyToProperties:g}=a,_=d[p].properties.map(({value:P})=>P).every(P=>(g||[]).indexOf(P)===-1),h=ve(n,u,p),x=Se(o,h?.conditions??[]);if(l[p]||(l[p]={}),se(g)||_)return l[p][u]={properties:{enabled:h!==void 0},conditions:x},l;const O=rs(g,d[p],h);return l[p][u]={...O,conditions:x},l},{});return Ye(r,i)},{}),Be=(e,t)=>Object.entries(Ce(e,t)).map(([o,n])=>({category:o,categoryId:o.split(" ").join("-"),childrenForm:Object.entries(Ce(n,"subCategory")).map(([r,a])=>({subCategoryName:r,subCategoryId:r.split(" ").join("-"),actions:a}))})),le=e=>Object.keys(e).reduce((t,o)=>{const n=e[o];if((0,w.F)(n)&&!ae(n,"conditions"))return{...t,[o]:le(n)};if((0,w.F)(n)&&ae(n,"conditions")&&!X(be(n,"conditions")).some(a=>a)){const a=Object.keys(n.conditions).reduce((d,i)=>(d[i]=!1,d),{});return{...t,[o]:{...n,conditions:a}}}return t[o]=n,t},{}),te=(e,t,o=!1)=>Object.keys(e).reduce((n,r)=>{const a=e[r];return r==="conditions"&&!o?(n[r]=a,n):(0,w.F)(a)?{...n,[r]:te(a,t,r==="fields")}:(n[r]=t,n)},{}),F=`${120/16}rem`,fe=`${200/16}rem`,de=`${53/16}rem`,_e=e=>e?Object.entries(e).reduce((t,[o,n])=>(o!=="conditions"&&(t[o]=n),t),{}):null,Y=e=>{const t=_e(e),o=X(t);if(!o.length)return{hasAllActionsSelected:!1,hasSomeActionsSelected:!1};const n=o.every(a=>a),r=o.some(a=>a)&&!n;return{hasAllActionsSelected:n,hasSomeActionsSelected:r}},ce=e=>e.charAt(0).toUpperCase()+e.slice(1),Re=(0,L.Ay)(m.s)`
...
`,xs=({onClick:e,className:t,hasConditions:o=!1,variant:n="tertiary"})=>{const{formatMessage:r}=(0,K.A)();return(0,s.jsx)(fs,{hasConditions:o,className:t,children:(0,s.jsx)($.$,{variant:n,startIcon:(0,s.jsx)(ze.A,{}),onClick:e,children:r({id:"global.settings",defaultMessage:"Settings"})})})},fs=(0,L.Ay)(j.a)`
  ...
  `}
`,pe=(0,L.Ay)(xs)``,Ke=({actions:e=[],headerBreadCrumbs:t=[],isFormDisabled:o,onClosed:n,onToggle:r})=>{const{formatMessage:a}=(0,K.A)(),{availableConditions:d,modifiedData:i,onChangeConditions:l}=Z(),p=y.useMemo(()=>Object.entries(Ce(d,"category")),[d]),u=e.filter(({isDisplayed:h,hasSomeActionsSelected:x,hasAllActionsSelected:O})=>h&&Boolean(x||O)),[g,C]=y.useState(_s(u,i,p)),f=(h,x)=>{C((0,Ee.Ay)(O=>{O[h]||(O[h]={}),O[h].default||(O[h].default={}),O[h].default=x}))},_=()=>{const h=Object.entries(g).reduce((x,O)=>{const[P,B]=O,E=Object.values(B).reduce((b,D)=>({...b,...D}),{});return x[P]=E,x},{});l(h),r()};return(0,s.jsxs)(S.k,{labelledBy:"condition-modal-breadcrumbs",onClose:n,children:[(0,s.jsx)(I.r,{children:(0,s.jsx)(es.B,{id:"condition-modal-breadcrumbs",label:t.join(", "),children:t.map((h,x,O)=>(0,s.jsx)(ss.m,{isCurrent:x===O.length-1,children:ts(a({id:h,defaultMessage:h}))},h))})}),(0,s.jsxs)(J.c,{children:[u.length===0&&(0,s.jsx)(A.o,{children:a({id:"Settings.permissions.conditions.no-actions",defaultMessage:"You first need to select actions (create, read, update, ...) before defining conditions on them."})}),(0,s.jsx)("ul",{children:u.map(({actionId:h,label:x,pathToConditionsObject:O},P)=>{const B=O.join("..");return(0,s.jsx)(ys,{arrayOfOptionsGroupedByCategory:p,label:x,isFormDisabled:o,isGrey:P%2===0,name:B,onChange:f,value:M(g,B,{})},h)})})]}),(0,s.jsx)(Q.j,{startActions:(0,s.jsx)($.$,{variant:"tertiary",onClick:r,children:a({id:"app.components.Button.cancel",defaultMessage:"Cancel"})}),endActions:(0,s.jsx)($.$,{onClick:_,children:a({id:"Settings.permissions.conditions.apply",defaultMessage:"Apply"})})})]})},_s=(e,t,o)=>e.reduce((n,r)=>{const a=M(t,[...r.pathToConditionsObject,"conditions"],{}),d=o.reduce((i,l)=>{const[p,u]=l,g=u.reduce((C,f)=>(C[f.id]=M(a,f.id,!1),C),{});return i[p]=g,i},{});return n[r.pathToConditionsObject.join("..")]=d,n},{}),ys=({arrayOfOptionsGroupedByCategory:e,isFormDisabled:t=!1,isGrey:o=!1,label:n,name:r,onChange:a,value:d})=>{const{formatMessage:i}=(0,K.A)(),l=p=>{a&&a(r,Os(e,p))};return(0,s.jsxs)(m.s,{as:"li",background:o?"neutral100":"neutral0",paddingBottom:3,paddingTop:3,children:[(0,s.jsxs)(m.s,{paddingLeft:6,style:{width:180},children:[(0,s.jsxs)(A.o,{variant:"sigma",textColor:"neutral600",children:[i({id:"Settings.permissions.conditions.can",defaultMessage:"Can"}),"\xA0"]}),(0,s.jsx)(A.o,{variant:"sigma",title:n,textColor:"primary600",ellipsis:!0,children:i({id:`Settings.roles.form.permissions.${n.toLowerCase()}`,defaultMessage:n})}),(0,s.jsxs)(A.o,{variant:"sigma",textColor:"neutral600",children:["\xA0",i({id:"Settings.permissions.conditions.when",defaultMessage:"When"})]})]}),(0,s.jsx)(j.a,{style:{maxWidth:430,width:"100%"},children:(0,s.jsx)(ue.B,{id:r,customizeContent:(p=[])=>`${p.length} currently selected`,onChange:l,value:js(d),options:As(e),disabled:t})})]})},js=e=>Object.values(e).map(t=>Object.entries(t).filter(([,o])=>o).map(([o])=>o)).flat(),As=e=>e.reduce((t,[o,n])=>(t.push({label:ce(o),children:n.map(r=>({label:r.displayName,value:r.id}))}),t),[]),Os=(e,t)=>e.map(([,o])=>o).flat().reduce((o,n)=>({[n.id]:t.includes(n.id),...o}),{}),Es=({actions:e=[],isFormDisabled:t,pathToData:o,subjects:n=[]})=>{const[r,a]=y.useState(null),d=i=>()=>{a(r===i?null:i)};return(0,s.jsx)(s.Fragment,{children:n.map(({uid:i,label:l,properties:p},u)=>{const g=r===i,C=e.map(f=>({...f,isDisplayed:Array.isArray(f.subjects)&&f.subjects.indexOf(i)!==-1}));return(0,s.jsxs)(m.s,{direction:"column",display:"inline-flex",minWidth:"100%",borderColor:"primary600",borderWidth:g?1:0,children:[(0,s.jsx)(bs,{availableActions:C,isActive:g,isGrey:u%2===0,isFormDisabled:t,label:l,onClickToggle:d(i),pathToData:[o,i].join("..")}),g&&p.map(({label:f,value:_,children:h})=>(0,s.jsx)(as,{availableActions:C,childrenForm:h,isFormDisabled:t,label:f,pathToData:[o,i].join(".."),propertyName:_},_))]},i)})})},bs=({availableActions:e=[],isActive:t=!1,isGrey:o=!1,isFormDisabled:n=!1,label:r,onClickToggle:a,pathToData:d})=>{const[i,l]=y.useState(!1),{formatMessage:p}=(0,K.A)(),{modifiedData:u,onChangeParentCheckbox:g,onChangeSimpleCheckbox:C}=Z(),f=()=>{l(b=>!b)},_=()=>{l(!1)},h=M(u,d.split(".."),{}),x=y.useMemo(()=>Object.keys(h).reduce((b,D)=>(b[D]=be(h[D],"conditions"),b),{}),[h]),{hasAllActionsSelected:O,hasSomeActionsSelected:P}=Y(x),B=y.useMemo(()=>Ms(e,u,d),[e,u,d]),E=B.some(b=>b.hasConditions);return(0,s.jsxs)(vs,{isActive:t,children:[(0,s.jsxs)(Ue,{height:de,flex:1,alignItems:"center",background:o?"neutral100":"neutral0",children:[(0,s.jsx)(We,{isCollapsable:!0,isFormDisabled:n,label:r,checkboxName:d,onChange:g,onClick:a,someChecked:P,value:O,isActive:t,children:(0,s.jsx)(Ve,{paddingLeft:2,children:t?(0,s.jsx)(Qe.A,{}):(0,s.jsx)(qe.A,{})})}),(0,s.jsx)(m.s,{style:{flex:1},children:B.map(({actionId:b,hasSomeActionsSelected:D,isDisplayed:T,...W})=>{if(!T)return(0,s.jsx)(ye,{},b);const{hasConditions:U,hasAllActionsSelected:R,isParentCheckbox:z,checkboxName:G,label:ie}=W;return z?(0,s.jsxs)(Ne,{justifyContent:"center",alignItems:"center",children:[U&&(0,s.jsx)(j.a,{as:"span",position:"absolute",top:"-6px",left:"37px",width:"6px",height:"6px",borderRadius:"20px",background:"primary600"}),(0,s.jsx)(v.J,{disabled:n,name:G,"aria-label":p({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${ie} ${r}`}),onValueChange:V=>{g({target:{name:G,value:V}})},indeterminate:D,value:R})]},b):(0,s.jsxs)(Ne,{justifyContent:"center",alignItems:"center",children:[U&&(0,s.jsx)(j.a,{as:"span",position:"absolute",top:"-6px",left:"37px",width:"6px",height:"6px",borderRadius:"20px",background:"primary600"}),(0,s.jsx)(v.J,{disabled:n,indeterminate:U,name:G,onValueChange:V=>{C({target:{name:G,value:V}})},value:R})]},b)})}),i&&(0,s.jsx)(Ke,{headerBreadCrumbs:[r,"Settings.permissions.conditions.conditions"],actions:B,isFormDisabled:n,onClosed:_,onToggle:f})]}),(0,s.jsx)(j.a,{transform:"translateY(10px)",right:"9px",position:"absolute",children:(0,s.jsx)(pe,{onClick:f,hasConditions:E})})]})},Ms=(e,t,o)=>e.map(({actionId:n,isDisplayed:r,applyToProperties:a,label:d})=>{if(!r)return{actionId:n,hasSomeActionsSelected:!1,isDisplayed:r};const i=[...o.split(".."),n],l=se(a)?[...i,"properties","enabled"]:i,p=M(t,[...i,"conditions"],null),u={actionId:n,checkboxName:l.join(".."),hasConditions:X(p).some(_=>_),isDisplayed:r,label:d,pathToConditionsObject:i};if(se(a)){const _=M(t,l,!1);return{...u,hasAllActionsSelected:_,hasSomeActionsSelected:_,isParentCheckbox:!1}}const g=M(t,l,null),{hasAllActionsSelected:C,hasSomeActionsSelected:f}=Y(g);return{...u,hasAllActionsSelected:C,hasSomeActionsSelected:f,isParentCheckbox:!0}}),je=(e,t)=>`
  ${Ue} {
